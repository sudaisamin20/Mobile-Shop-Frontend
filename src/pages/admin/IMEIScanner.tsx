...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: "imei", label: "IMEI Scanner", icon: ScanBarcode, badge: 0 },
          ...
          <header className="flex items-center justify-between px-4 sm:px-6 h-16 border-b border-white/8 bg-[#0b0614]/60 backdrop-blur-xl flex-shrink-0 gap-3">
            <div className="flex items-center gap-3">
              <button
                ...
                className="md:hidden w-9 h-9 flex items-center justify-center rounded-xl text-gray-400 hover:text-white hover:bg-white/8 border border-white/8 transition-all cursor-pointer"
              >
                <ScanBarcode size={18} />
              </button>
              <div>
                <h1 className="text-white font-black text-base leading-tight flex items-center gap-2">
                  <ScanBarcode size={18} className="text-yellow-400" />
                  IMEI Scanner
                </h1>
                <p className="text-gray-500 text-[11px]">
                  Scan or enter device IMEI numbers
                </p>
              </div>
            </div>
                  ...
                  <AnimateIn delay={100}>
                    <Card padding="md">
                      ...
                      <p className="text-gray-400 text-sm mb-4">
                        Type or paste the 15-digit IMEI number from the device.
                      </p>
                      ...
                      {scanResult ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-10 gap-3">
                          <div className="w-16 h-16 rounded-2xl bg-white/4 border border-white/8 flex items-center justify-center">
                            <ScanBarcode size={28} className="text-gray-600" />
                          </div>
